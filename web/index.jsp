...
<meta name="theme-color" content="#712cf9">
    ...
    <link href="assets/css/sign-in.css" rel="stylesheet" type="text/css"/>
  </head>
  <body class="d-flex align-items-center py-4 bg-body-tertiary h-auto">
...
<main class="form-signin w-100 m-auto">
  <form action="ControladorValidar" method="POST">
    ...
    <div class="form-floating">
      <input type="text" name="txtuser" class="form-control" id="floatingInput" placeholder="Usuario">
    ...
    <button class="btn btn-primary w-100 py-2" name="accion" value="ingresar" type="submit">Ingresar</button>
